...
{
    SEMANT_VERBOSE_ONLY(_logger->log_enter("check class hierarchy"));
    ...
    SEMANT_VERBOSE_ONLY(_logger->log_exit("check class hierarchy"));
    return true;
}
...
{
    SEMANT_VERBOSE_ONLY(_logger->log_enter("check main"));
    ...
    SEMANT_VERBOSE_ONLY(_logger->log_exit("check main"));
    return true;
}
...
bool Semant::check_classes()
{
    ...
    SEMANT_VERBOSE_ONLY(_logger->log_enter("create basic classes"));
    ...
    SEMANT_VERBOSE_ONLY(_logger->log_exit("create basic classes"));
...
{
    SEMANT_VERBOSE_ONLY(_logger->log_enter("check method " + feature->_object->_object));
    ...
    SEMANT_VERBOSE_ONLY(_logger->log_exit("check method " + feature->_object->_object));
    return true;
}

bool Semant::check_expression_in_attribute(const std::shared_ptr<ast::Feature> &attr, Scope &scope)
{
    SEMANT_VERBOSE_ONLY(_logger->log_enter("check attribute " + attr->_object->_object));
    ...
    SEMANT_VERBOSE_ONLY(_logger->log_exit("check attribute " + attr->_object->_object));
    return true;
}

bool Semant::check_expressions_in_class(const std::shared_ptr<ClassNode> &node, Scope &scope)
{
    SEMANT_VERBOSE_ONLY(_logger->log_enter("check class " + node->_class->_type->_string));
    ...
    SEMANT_VERBOSE_ONLY(_logger->log_exit("check class " + node->_class->_type->_string));
    return true;
}
...
std::shared_ptr<ast::Type> Semant::infer_if_type(ast::IfExpression &branch, Scope &scope)
{
    ...
    SEMANT_VERBOSE_ONLY(_logger->log_exit("IF"));
...
{
    SEMANT_VERBOSE_ONLY(_logger->log_enter("SEQUENCE"));
...
std::shared_ptr<ast::Type> Semant::infer_cases_type(ast::CaseExpression &cases, Scope &scope)
{
    ...
    SEMANT_VERBOSE_ONLY(_logger->log_exit("CASE"));
...
{
    SEMANT_VERBOSE_ONLY(_logger->log_enter("DISPATCH"));
    ...
    SEMANT_VERBOSE_ONLY(_logger->log_exit("DISPATCH"));
